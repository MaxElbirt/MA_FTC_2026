...
public class Constants {
    ...
    public static final String SHOOTER1_NAME = "shooterMotor1";
    public static final String SHOOTER2_NAME = "shooterMotor2";
    ...
    public static final double STEERING_KP = 0.02;
